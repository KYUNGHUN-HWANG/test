...
extern void Set_LinToCan_L_EVNT_HU_FrDrEvntPtDisp_XY(Lvnt_1_data *L1_DataBuf, lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl);
extern void Set_LinToCan_L_EVNT_HU_FrPsEvntPtDisp_XY(Lvnt_2_data *L2_DataBuf, lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl);
