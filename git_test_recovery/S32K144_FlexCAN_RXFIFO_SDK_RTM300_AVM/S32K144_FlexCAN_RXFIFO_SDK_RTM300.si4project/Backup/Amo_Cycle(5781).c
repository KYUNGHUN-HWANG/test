...
uint8_t FrDrCycleMode_Flag = FALSE;
uint8_t FrPsCycleMode_Flag = FALSE;
uint8_t FrDrPsCycleMode_Flag = FALSE;
...
volatile bool SLLR_OP_check;
volatile bool SLUD_OP_check;
volatile bool CLLR_OP_check;
volatile bool CLUD_OP_check;
volatile bool SRLR_OP_check;
volatile bool SRUD_OP_check;
volatile bool CRLR_OP_check;
volatile bool CRUD_OP_check;
...
{
		l_bool_wr_LI1_FR_SRLR_OpDone(1);
		l_bool_wr_LI1_FR_SRUD_OpDone(1);
		l_bool_wr_LI1_FR_CRLR_OpDone(1);
		l_bool_wr_LI1_FR_CRUD_OpDone(1);

		l_bool_wr_LI0_FR_SLLR_OpDone(1);
		l_bool_wr_LI0_FR_SLUD_OpDone(1);
		l_bool_wr_LI0_FR_CLLR_OpDone(1);
		l_bool_wr_LI0_FR_CLUD_OpDone(1);
...
void lin_FrDrPsSwingData_Scenario1(void)
{
...
#if defined(NOISE_TEST)
	SetLIN_EVNT_FrDrSPEED(&LIN_LH_EVNT_MASTER_CMD, ACT_RPM_10); //noise test
	SetLIN_EVNT_FrPsSPEED(&LIN_RH_EVNT_MASTER_CMD, ACT_RPM_10);
#else
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check32);
}
...
void OpDone_Check32(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check32);
...
void lin_FrDrPsSwingData_Scenario2(void)
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Max_UD;//Min_UD;
			#else
		...
		if(Hu_Fr_Ps_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Max_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Min_UD;//Max_UD;
			#else
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check33);
}
...
void OpDone_Check33(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check33);
...
void lin_FrDrPsSwingData_Scenario3(void)
{
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check34);
}
...
void OpDone_Check34(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check34);
...
void lin_FrDrPsSwingData_Scenario4(void)
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_LeftRight_TargetPosition = Max_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Min_UD;//Max_UD;
			#else
		...
		if(Hu_Fr_Ps_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Min_LR;
			#if defined(ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Max_UD;//Min_UD;
			#else
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check35);
}
...
void OpDone_Check35(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check35);
...
void lin_FrDrPsSwingData_Scenario5(void)
{
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check36);
}
...
void OpDone_Check36(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check36);
...
void lin_FrDrCycleMode_task_Backup(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl)
{
	recoveryFinishFlag_cllr = FALSE;
	recoveryFinishFlag_clud = FALSE;
	recoveryFinishFlag_sllr = FALSE;
...
void lin_FrDrSwingData_Scenario0()
{
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check1);
}
...
//	l_bool_wr_LI0_FR_CLUD_OpDone(1);
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check1);
...
void lin_FrDrSwingData_Scenario1()
{
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check2);
...
void OpDone_Check2(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check2);
...
void lin_FrDrSwingData_Scenario2()
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_LeftRight_TargetPosition = Min_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Max_UD; //250; //260 26degree;
			#else
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Min_UD;//Min_UD; //250; //260 26degree;
			#endif
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check3);
...
void OpDone_Check3(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check3);
...
void lin_FrDrSwingData_Scenario3()
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_LeftRight_TargetPosition = Max_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Max_UD;//Min_UD; //250; //260;
			#else
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Min_UD;
			#endif
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check4);
...
void OpDone_Check4(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check4);
...
void lin_FrDrSwingData_Scenario4()
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_LeftRight_TargetPosition = Max_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Min_UD; //Max_UD; //24degree // 1798 25degree; // 1788 26degree (2048-1788);
			#else
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Max_UD;
			#endif
	...
	if(ATCU_DriverSideType == RHD)
	{
		if(Hu_Fr_Ps_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_LeftRight_TargetPosition = Max_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_LH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = Min_UD; //24degree // 1798 25degree; // 1788 26degree (2048-1788);
			#else
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check5);
...
void OpDone_Check5(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check5);
...
void lin_FrDrSwingData_Scenario5()
{
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check6);
...
void OpDone_Check6(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check6);
...
void lin_FrPsCycleMode_task_Backup(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl)
{
...
void lin_FrPsSwingData_Scenario0()
{
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check11);  //1199
}
...
void OpDone_Check11(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check11);
...
void lin_FrPsSwingData_Scenario1()
{
...
#if defined(NOISE_TEST)
	SetLIN_EVNT_FrPsSPEED(&LIN_RH_EVNT_MASTER_CMD, ACT_RPM_10); //noise test
#else
	SetLIN_EVNT_FrPsSPEED(&LIN_RH_EVNT_MASTER_CMD, ACT_RPM_3);
#endif
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check12);
...
void OpDone_Check12(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check12);
...
void lin_FrPsSwingData_Scenario2()
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_Ps_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Max_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Min_UD;//Max_UD; //250; //260 26degree;
			#else
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Max_UD;
			#endif
	...
	if(ATCU_DriverSideType == RHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Max_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Min_UD; //250; //260 26degree;
			#else
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check13);
}
...
void OpDone_Check13(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check13);
...
void lin_FrPsSwingData_Scenario3()
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_Ps_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Min_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Min_UD;//Max_UD; //250; //260;
			#else
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Max_UD;
			#endif
	...
	if(ATCU_DriverSideType == RHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Min_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Min_UD; //250; //260;
			#else
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check14);
}
...
void OpDone_Check14(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check14);
...
void lin_FrPsSwingData_Scenario4()
{
	...
	if(ATCU_DriverSideType == LHD)
	{
		if(Hu_Fr_Ps_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Min_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Max_UD;//Min_UD; //24degree // 1798 25degree; // 1788 26degree (2048-1788);
			#else
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Min_UD;
			#endif
	...
	if(ATCU_DriverSideType == RHD)
	{
		if(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)
		{
			...
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_LeftRight_TargetPosition = Min_LR;
			#if defined (ACT_ANGLE_UPDATE_3)
			LIN_RH_EVNT_MASTER_CMD.LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = Max_UD; //24degree // 1798 25degree; // 1788 26degree (2048-1788);
			#else
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check15);
}
...
void OpDone_Check15(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check15);
...
void lin_FrPsSwingData_Scenario5()
{
	...
	Amo_timer_Stop(timer_70);
	Amo_timer_Start(timer_70, 1000, false, OpDone_Check16);
}
...
void OpDone_Check16(void)
{
	...
	Amo_timer_Stop(timer_71);
	Amo_timer_Start(timer_71, 50, false, OpDone_Check16);
...
void Set_LinToCan_Disp_FrDrCycle_XY(void)
{
	...
	Hu_FrDrEVntSidePt_X_backup = Can_Tx_Evnt_1.data.L_EVNT_HU_FrDrEvntSidePtDisp_X;
	Hu_FrDrEVntSidePt_Y_backup = Can_Tx_Evnt_1.data.L_EVNT_HU_FrDrEvntSidePtDisp_Y;
	Hu_FrDrEVntCtrPt_X_backup = Can_Tx_Evnt_1.data.L_EVNT_HU_FrDrEvntCtrPtDisp_X;
	Hu_FrDrEVntCtrPt_Y_backup = Can_Tx_Evnt_1.data.L_EVNT_HU_FrDrEvntCtrPtDisp_Y;
...
void Set_LinToCan_Disp_FrPsCycle_XY(void)
{
	...
	Hu_FrPsEVntSidePt_X_backup = Can_Tx_Evnt_2.data.L_EVNT_HU_FrPsEvntSidePtDisp_X;
	Hu_FrPsEVntSidePt_Y_backup = Can_Tx_Evnt_2.data.L_EVNT_HU_FrPsEvntSidePtDisp_Y ;
	Hu_FrPsEVntCtrPt_X_backup = Can_Tx_Evnt_2.data.L_EVNT_HU_FrPsEvntCtrPtDisp_X;
	Hu_FrPsEVntCtrPt_Y_backup = Can_Tx_Evnt_2.data.L_EVNT_HU_FrPsEvntCtrPtDisp_Y;
...
#endif  /* defined(CYCLE_OPDONE) */



#if defined(CYCLE_TIMER)
