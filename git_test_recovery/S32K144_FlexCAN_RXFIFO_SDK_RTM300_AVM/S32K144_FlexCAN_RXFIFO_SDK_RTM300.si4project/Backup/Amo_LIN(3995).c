...
//	Amo_timer_Start(timer_60, OPDONE_TIMEOUT_MANUAL_160_DEGREE_UNDER, true, Opdone_TimeOut_LH_Check);
	...
	Can_Tx_Evnt_4.data.L_EVNT_FrDrEvntSideOpnCls = Hu_Fr_dr_Vent_Side_signal_backup;
	Can_Tx_Evnt_4.data.L_EVNT_FrDrEvntCtrOpnCls = Hu_Fr_dr_Vent_Center_signal_backup;
}
...
//	Amo_timer_Start(timer_63, OPDONE_TIMEOUT_MANUAL_160_DEGREE_UNDER, true, Opdone_TimeOut_RH_Check);
	...
	Can_Tx_Evnt_4.data.L_EVNT_FrPsEvntSideOpnCls = Hu_Fr_Ps_Vent_Side_signal_backup;
	Can_Tx_Evnt_4.data.L_EVNT_FrPsEvntCtrOpnCls = Hu_Fr_Ps_Vent_Center_signal_backup;	
}
...
void lin_FrDrVent_FullClose_Mode_task(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
	...
	SetLIN_EVNT_FrDrSPEED(&LIN_LH_EVNT_MASTER_CMD, ACT_RPM_2); //hkh
	...
	if(Hu_Fr_dr_Vent_Side_signal_backup == 0x02) //fullclose
	{
		...
		lin_Ctrl->LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = FullClose_UD_Rev;
		#else
	...
	if(Hu_Fr_Ps_Vent_Mode == SWING_MODE && (Hu_Fr_dr_Vent_Center_signal_backup == 0x02 && Hu_Fr_dr_Vent_Side_signal_backup == 0x02))
	{
...
void lin_FrDrVent_Focus_Mode_task(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
	...
	if((Hu_Fr_Dr_Vent_Mode == FACING_MODE) && (Hu_Fr_dr_Vent_Side_signal_backup != 0x02)) //focus mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
		...
		lin_Ctrl->LDATA.EVNT_Front_Side_LH_UpDown_TargetPosition = FocusSpread_UD_Rev;
	...
	if((Hu_Fr_Dr_Vent_Mode == FACING_MODE) && (Hu_Fr_dr_Vent_Center_signal_backup != 0x02)) //focus mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
		...
		#if defined (ACT_ANGLE_UPDATE_2) || defined (ACT_ANGLE_UPDATE_3)
...
void RHD_lin_FrDrVent_Focus_Mode_task(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl)
{
	...
	if((Hu_Fr_Ps_Vent_Mode == FACING_MODE) && (Hu_Fr_Ps_Vent_Side_signal_backup != 0x02))//focus mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
	...
	if((Hu_Fr_Ps_Vent_Mode == FACING_MODE) && (Hu_Fr_Ps_Vent_Center_signal_backup != 0x02)) //focus mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
...
void lin_FrDrVent_Spread_Mode_task(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
	...
	if((Hu_Fr_Dr_Vent_Mode == AVOID_MODE) &&(Hu_Fr_dr_Vent_Side_signal_backup != 0x02)) //spread mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
	...
	if((Hu_Fr_Dr_Vent_Mode == AVOID_MODE) && (Hu_Fr_dr_Vent_Center_signal_backup != 0x02)) //spread mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
...
void RHD_lin_FrDrVent_Spread_Mode_task(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl)
{
	...
	if((Hu_Fr_Ps_Vent_Mode == AVOID_MODE)&& (Hu_Fr_Ps_Vent_Side_signal_backup != 0x02)) //spread mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
	...
	if((Hu_Fr_Ps_Vent_Mode == AVOID_MODE)&& (Hu_Fr_Ps_Vent_Center_signal_backup != 0x02)) //spread mode
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
...
void lin_FrDrVent_FullClose_Mode_task_Backup(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
	...
	if((Hu_Fr_dr_Vent_Side_signal_backup == 0x02) && (Hu_Fr_dr_Vent_Side_signal != 0x02)) //fullclose
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
		SetLIN_EVNT_FrDrSPEED(&LIN_LH_EVNT_MASTER_CMD, ACT_RPM_10);
	...
	if((Hu_Fr_dr_Vent_Center_signal_backup == 0x02) && (Hu_Fr_dr_Vent_Center_signal != 0x02)) //fullclose
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
		SetLIN_EVNT_FrDrSPEED(&LIN_LH_EVNT_MASTER_CMD, ACT_RPM_10);
...
void RHD_lin_FrDrVent_FullClose_Mode_task_Backup(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl)
{
	...
	if((Hu_Fr_Ps_Vent_Side_signal_backup == 0x02) && (Hu_Fr_Ps_Vent_Side_signal != 0x02)) //fullclose
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
		SetLIN_EVNT_FrDrSPEED(&LIN_LH_EVNT_MASTER_CMD, ACT_RPM_10);
	...
	if((Hu_Fr_Ps_Vent_Center_signal_backup == 0x02) && (Hu_Fr_Ps_Vent_Center_signal != 0x02))//fullclose
	{
		lin_FrDrCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
		SetLIN_EVNT_FrDrSPEED(&LIN_LH_EVNT_MASTER_CMD, ACT_RPM_10);
...
void lin_FrPsVent_FullClose_Mode_task(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl)
{
	...
	SetLIN_EVNT_FrPsSPEED(&LIN_RH_EVNT_MASTER_CMD, ACT_RPM_2); //hkh
	...
	{
		if(Hu_Fr_Ps_Vent_Mode == SWING_MODE && Hu_Fr_Dr_Vent_Mode == SWING_MODE)
		{
			lin_FrDrPsCycleMode_task();
		}	
	...
	if(Hu_Fr_Dr_Vent_Mode == SWING_MODE && (Hu_Fr_Ps_Vent_Center_signal_backup == 0x02 && Hu_Fr_Ps_Vent_Side_signal_backup == 0x02))
	{
		lin_FrDrCycleMode_task(&LIN_LH_EVNT_MASTER_CMD);
	}	
...
void lin_FrPsVent_Spread_Mode_task(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl)
{
	...
	if((Hu_Fr_Ps_Vent_Mode == AVOID_MODE)&&(Hu_Fr_Ps_Vent_Side_signal_backup != 0x02))//spread mode
	{
		...
		#elif defined (ACT_ANGLE_UPDATE_3)
		lin_Ctrl->LDATA.EVNT_Front_Side_RH_UpDown_TargetPosition = FocusSpread_UD;
		#else
...
void lin_FrPsVent_Focus_Mode_task_Backup(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl)
{
	...
	if((Hu_Fr_Ps_Vent_Mode == FACING_MODE)&&(Hu_Fr_Ps_Vent_Center_signal != 0x02)) //focus mode
	{
		lin_FrPsCycleMode_TimerStop();
		lin_CycleMode_CanDisp_TimerStop();
...
void Set_LinToCan_Disp_FrDr_Mode(Lvnt_4_data *L4_DataBuf)
{
	...
	L4_DataBuf->data.L_EVNT_FrDrEvntSideOpnCls = Hu_Fr_dr_Vent_Side_signal_backup;
	L4_DataBuf->data.L_EVNT_FrDrEvntCtrOpnCls = Hu_Fr_dr_Vent_Center_signal_backup;
}

void Set_LinToCan_Disp_FrPs_Mode(Lvnt_4_data *L4_DataBuf)
{
	L4_DataBuf->data.L_EVNT_FrPsEvntModeSet = Hu_Fr_Ps_Vent_Mode;
	L4_DataBuf->data.L_EVNT_FrPsEvntSideOpnCls = Hu_Fr_Ps_Vent_Side_signal_backup;
	L4_DataBuf->data.L_EVNT_FrPsEvntCtrOpnCls = Hu_Fr_Ps_Vent_Center_signal_backup;
}
