...
extern void Lin_Scheduler_SpecialCmd_Start_1_LH(void);
extern void Lin_Scheduler_SpecialCmd_Start_1_RH(void);
...
extern void ClearState_Steploss_OpDone_Check_sllr(void);
extern void ClearState_Steploss_OpDone_Check_slud(void);
extern void ClearState_Steploss_OpDone_Check_cllr(void);
extern void ClearState_Steploss_OpDone_Check_clud(void);
extern void ClearState_Steploss_OpDone_Check_crlr(void);
extern void ClearState_Steploss_OpDone_Check_crud(void);
extern void ClearState_Steploss_OpDone_Check_srlr(void);
extern void ClearState_Steploss_OpDone_Check_srud(void);

extern void Recovery_Clear_goToTargetPt_FR_SRUD_1(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl, Lin_EVntPt_t *lin_Pt);
extern void Recovery_CycleMode_ReStart(void);

extern void Recovery_CantGoToZeroPt_ClearFunc_sllr(void);
extern void Recovery_CantGoToZeroPt_ClearFunc_slud(void);
extern void Recovery_CantGoToZeroPt_ClearFunc_cllr(void);
extern void Recovery_CantGoToZeroPt_ClearFunc_clud(void);
extern void Recovery_CantGoToZeroPt_ClearFunc_crlr(void);
extern void Recovery_CantGoToZeroPt_ClearFunc_crud(void);
extern void Recovery_CantGoToZeroPt_ClearFunc_srlr(void);
extern void Recovery_CantGoToZeroPt_ClearFunc_srud(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_cllr(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_clud(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_sllr(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_slud(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_crlr(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_crud(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_srlr(void);
extern void Recovery_Repeat_zeroPt_ClearFunc_srud(void);
