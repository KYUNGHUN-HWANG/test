...
void Lin_Scheduler_SpecialCmd_Start_1(void)
{
	...
	if(recoveryFlags.FR_SRLR_Recov_Flag == TRUE || recoveryFlags.FR_SRUD_Recov_Flag == TRUE || recoveryFlags.FR_CRLR_Recov_Flag == TRUE || recoveryFlags.FR_CRUD_Recov_Flag == TRUE)
	{
		...
		Amo_timer_Stop(timer_123);
		Amo_timer_Start(timer_123, 50, false, Evnt_RH_Special_Cmd_1); //20	
	}
}
...
void Recovery_goToTargetPt_FR_SLLR_1(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
	if((lin_Pt->FrDrPt.prevPt_FR_SLLR) != (lin_Pt->FrDrPt.currentPt_FR_SLLR))
	{
		...
		Amo_timer_Stop(timer_92);
		Amo_timer_Start(timer_92, 100, true, goToTargetPt_OpDone_Check_sllr); //50 //1000
...
void Recovery_goToTargetPt_FR_SLUD_1(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
    if((lin_Pt->FrDrPt.prevPt_FR_SLUD) != (lin_Pt->FrDrPt.currentPt_FR_SLUD))
    {
        ...
        Amo_timer_Stop(timer_118);
				Amo_timer_Start(timer_118, 100, true, goToTargetPt_OpDone_Check_slud); //50 //1000
    }
}
...
void Recovery_goToTargetPt_FR_CRLR_1(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
    if((lin_Pt->FrPsPt.prevPt_FR_CRLR) != (lin_Pt->FrPsPt.currentPt_FR_CRLR))
    {
        ...
        lin_Write_FrPsEVntPt_XY(&LIN_RH_EVNT_MASTER_CMD, &Can_Tx_Evnt_3);
       	...
       	Amo_timer_Stop(timer_119);
				Amo_timer_Start(timer_119, 100, true, goToTargetPt_OpDone_Check_crlr); //50 //1000
    }
}
...
void Recovery_goToTargetPt_FR_CRUD_1(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
    if((lin_Pt->FrPsPt.prevPt_FR_CRUD) != (lin_Pt->FrPsPt.currentPt_FR_CRUD))
    {
        ...
        lin_Write_FrPsEVntPt_XY(&LIN_RH_EVNT_MASTER_CMD, &Can_Tx_Evnt_3);
       	...
       	Amo_timer_Stop(timer_120);
				Amo_timer_Start(timer_120, 100, true, goToTargetPt_OpDone_Check_crud); //50 //1000
    }
}
...
void Recovery_goToTargetPt_FR_SRLR_1(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
    if((lin_Pt->FrPsPt.prevPt_FR_SRLR) != (lin_Pt->FrPsPt.currentPt_FR_SRLR))
    {
        ...
        lin_Write_FrPsEVntPt_XY(&LIN_RH_EVNT_MASTER_CMD, &Can_Tx_Evnt_3);
       	...
       	Amo_timer_Stop(timer_121);
				Amo_timer_Start(timer_121, 100, true, goToTargetPt_OpDone_Check_srlr); //50 //1000
    }
}
...
void Recovery_goToTargetPt_FR_SRUD_1(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
    if((lin_Pt->FrPsPt.prevPt_FR_SRUD) != (lin_Pt->FrPsPt.currentPt_FR_SRUD))
    {
        ...
        lin_Write_FrPsEVntPt_XY(&LIN_RH_EVNT_MASTER_CMD, &Can_Tx_Evnt_3);
       	...
       	Amo_timer_Stop(timer_122);
				Amo_timer_Start(timer_122, 100, true, goToTargetPt_OpDone_Check_srud); //50 //1000
    }
}
    ...
    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 2)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_106);
                Amo_timer_Start(timer_106, 300, false, Check_300ms_2_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 3)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_106);
                Amo_timer_Start(timer_106, 300, false, Check_300ms_3_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 4)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_106);
                Amo_timer_Start(timer_106, 300, false, Check_300ms_4_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_slud == FALSE && eventCountTest_slud == 1)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_107);
                Amo_timer_Start(timer_107, 300, false, Check_300ms_1_slud);
            }
        }
    ...
    if(zero_flag_slud == FALSE && eventCountTest_slud == 2)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_107);
                Amo_timer_Start(timer_107, 300, false, Check_300ms_2_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_slud == FALSE && eventCountTest_slud == 3)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_107);
                Amo_timer_Start(timer_107, 300, false, Check_300ms_3_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_slud == FALSE && eventCountTest_slud == 4)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_107);
                Amo_timer_Start(timer_107, 300, false, Check_300ms_4_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 1)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_108);
                Amo_timer_Start(timer_108, 300, false, Check_300ms_1_crlr);
            }
        }
    ...
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 2)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_108);
                Amo_timer_Start(timer_108, 300, false, Check_300ms_2_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 3)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_108);
                Amo_timer_Start(timer_108, 300, false, Check_300ms_3_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 4)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_108);
                Amo_timer_Start(timer_108, 300, false, Check_300ms_4_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crud == FALSE && eventCountTest_crud == 1)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_109);
                Amo_timer_Start(timer_109, 300, false, Check_300ms_1_crud);
            }
        }
    ...
    if(zero_flag_crud == FALSE && eventCountTest_crud == 2)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_109);
                Amo_timer_Start(timer_109, 300, false, Check_300ms_2_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crud == FALSE && eventCountTest_crud == 3)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_109);
                Amo_timer_Start(timer_109, 300, false, Check_300ms_3_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crud == FALSE && eventCountTest_crud == 4)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_109);
                Amo_timer_Start(timer_109, 300, false, Check_300ms_4_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 1)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_110);
                Amo_timer_Start(timer_110, 300, false, Check_300ms_1_srlr);
            }
        }
    ...
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 2)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_110);
                Amo_timer_Start(timer_110, 300, false, Check_300ms_2_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 3)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_110);
                Amo_timer_Start(timer_110, 300, false, Check_300ms_3_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 4)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_110);
                Amo_timer_Start(timer_110, 300, false, Check_300ms_4_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srud == FALSE && eventCountTest_srud == 1)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_111);
                Amo_timer_Start(timer_111, 300, false, Check_300ms_1_srud);
            }
        }
    ...
    if(zero_flag_srud == FALSE && eventCountTest_srud == 2)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_111);
                Amo_timer_Start(timer_111, 300, false, Check_300ms_2_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srud == FALSE && eventCountTest_srud == 3)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_111);
                Amo_timer_Start(timer_111, 300, false, Check_300ms_3_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srud == FALSE && eventCountTest_srud == 4)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_111);
                Amo_timer_Start(timer_111, 300, false, Check_300ms_4_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
