...
void lin_Write_FrPsEVntPt_XY(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl)
{
	...
	Amo_timer_Start(timer_63, OPDONE_TIMEOUT_MANUAL_109_DEGREE_UNDER, true, Opdone_TimeOut_RH_Check);
}
...
void lin_Write_RrEVntConsPt_XY(lin_RC_EVNT_MASTER_CMD_31 *lin_Ctrl)
{
	...
	Amo_timer_Start(timer_66, OPDONE_TIMEOUT_MANUAL_109_DEGREE_UNDER, true, Opdone_TimeOut_RC_Check);
}
