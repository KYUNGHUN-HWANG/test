...
void RecoveryStart_goToZero_FR_SRL_1(lin_RH_EVNT_MASTER_CMD_21 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
    // recoveryCount++;
...
//		Lin_LH_Scheduler_Normal_Start_1();
		...
		if(gotoZeroPtFlag_cllr == TRUE)
		{
			//			goto 0 degree;
			Amo_timer_Stop(timer_93);
			Amo_timer_Start(timer_93, 50, false, RecoveryMode_LH_1_cllr); //50 //1000
		}
...
void Lin_LH_HardStop_1_sllr(t_lin_LH_FR_STATUS *lin_LH_Status, lin_LH_EVNT_SPECIAL_CMD_0 *lin_SpecialCtrl, lin_LH_EVNT_MASTER_CMD_11 *lin_LH_Ctrl)    
{
    ...
    if(specialCmdCount_sllr == 2)
    {
        ...
        {
            Amo_timer_Stop(timer_93);
            Amo_timer_Start(timer_93, 50, false, RecoveryMode_LH_1_sllr); //50 //1000
        }
...
void Lin_LH_HardStop_1_slud(t_lin_LH_FR_STATUS *lin_LH_Status, lin_LH_EVNT_SPECIAL_CMD_0 *lin_SpecialCtrl, lin_LH_EVNT_MASTER_CMD_11 *lin_LH_Ctrl)    
{
    ...
    if(l_flg_tst_LI0_EVNT_SPECIAL_COMMAND_flag())
    {
        ...
        if(recoveryFlags.FR_SLUD_Recov_Flag == TRUE)
        {
            ...
            if(lastTryFlag_slud == TRUE)
            {
                ...
                lin_LH_Ctrl->LDATA.EVNT_Front_Center_LH_UpDown_TargetPosition = l_u16_rd_LI0_FR_SLUD_ActuatorState();
                l_u16_wr_LI0_EVNT_Front_Center_LH_UpDown_TargetPosition(lin_LH_Ctrl->LDATA.EVNT_Front_Center_LH_UpDown_TargetPosition);
            }
        }
    }
    ...
    if(specialCmdCount_slud == 2)
    {
        ...
        {
            Amo_timer_Stop(timer_93);
            Amo_timer_Start(timer_93, 50, false, RecoveryMode_LH_1_slud); //50 //1000
        }
...
void Lin_RH_HardStop_1_crlr(t_lin_RH_FR_STATUS *lin_RH_Status, lin_RH_EVNT_SPECIAL_CMD_0 *lin_SpecialCtrl, lin_RH_EVNT_MASTER_CMD_21 *lin_RH_Ctrl)    
{
    ...
    {
        Amo_timer_Start(timer_61, 50, false, Evnt_RH_Special_Cmd_1); //20
    }
    ...
    if(specialCmdCount_crlr == 2)
    {
        ...
        {
            Amo_timer_Stop(timer_93);
            Amo_timer_Start(timer_93, 50, false, RecoveryMode_RH_1_crlr); //50 //1000
        }
        ...
        Amo_timer_Stop(timer_62);
        Amo_timer_Start(timer_62, 50, false, Lin_RH_Scheduler_Normal_Start_1); //20 //50 //500
    }
}
...
void Lin_RH_HardStop_1_crud(t_lin_RH_FR_STATUS *lin_RH_Status, lin_RH_EVNT_SPECIAL_CMD_0 *lin_SpecialCtrl, lin_RH_EVNT_MASTER_CMD_21 *lin_RH_Ctrl)    
{
    ...
    if(specialCmdCount_crud == 2)
    {
        ...
        {
            Amo_timer_Stop(timer_93);
            Amo_timer_Start(timer_93, 50, false, RecoveryMode_RH_1_crud); //50 //1000
        }
...
void Lin_RH_HardStop_1_srlr(t_lin_RH_FR_STATUS *lin_RH_Status, lin_RH_EVNT_SPECIAL_CMD_0 *lin_SpecialCtrl, lin_RH_EVNT_MASTER_CMD_21 *lin_RH_Ctrl)    
{
    ...
    if(specialCmdCount_srlr == 2)
    {
        ...
        {
            Amo_timer_Stop(timer_93);
            Amo_timer_Start(timer_93, 50, false, RecoveryMode_RH_1_srlr); //50 //1000
        }
...
void Lin_RH_HardStop_1_srud(t_lin_RH_FR_STATUS *lin_RH_Status, lin_RH_EVNT_SPECIAL_CMD_0 *lin_SpecialCtrl, lin_RH_EVNT_MASTER_CMD_21 *lin_RH_Ctrl)    
{
    ...
    if(l_flg_tst_LI1_EVNT_SPECIAL_COMMAND_flag())
    {
        ...
        if(recoveryFlags.FR_SRUD_Recov_Flag == TRUE)
        {
            ...
            if(lastTryFlag_srud == TRUE)
            {
                ...
                lin_RH_Ctrl->LDATA.EVNT_Front_Center_RH_UpDown_TargetPosition = l_u16_rd_LI1_FR_SRUD_ActuatorState();
                l_u16_wr_LI1_EVNT_Front_Center_RH_UpDown_TargetPosition(lin_RH_Ctrl->LDATA.EVNT_Front_Center_RH_UpDown_TargetPosition);
            }
        }
    }
    ...
    if(specialCmdCount_srud == 2)
    {
        ...
        {
            Amo_timer_Stop(timer_93);
            Amo_timer_Start(timer_93, 50, false, RecoveryMode_RH_1_srud); //50 //1000
        }
...
void Recovery_goToTargetPt_FR_CLLR_1(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
	if((lin_Pt->FrDrPt.prevPt_FR_CLLR) != (lin_Pt->FrDrPt.currentPt_FR_CLLR))
	{
		...
		Amo_timer_Stop(timer_95);
		Amo_timer_Start(timer_95, 100, true, goToTargetPt_OpDone_Check_cllr); //50 //1000

//		Amo_timer_Stop(timer_92);
//		Amo_timer_Start(timer_92, 1000, false, Check300ms_Func);
...
void Recovery_goToTargetPt_FR_CLUD_1(lin_LH_EVNT_MASTER_CMD_11 *lin_Ctrl, Lin_EVntPt_t *lin_Pt)
{
	if((lin_Pt->FrDrPt.prevPt_FR_CLUD) != (lin_Pt->FrDrPt.currentPt_FR_CLUD))
	{
		...
		Amo_timer_Stop(timer_99);
		Amo_timer_Start(timer_99, 100, true, goToTargetPt_OpDone_Check_clud); //50 //1000
...
void Check_300ms_crlr(void)
{
    ...
    {   
        ...
        if(cycleModeFlag_crlr == TRUE) { lin_FrDrCycleMode_TimerStop(); }
...
void Check_300ms_crud(void)
{
    ...
    {   
        ...
        if(cycleModeFlag_crud == TRUE) { lin_FrDrCycleMode_TimerStop(); }
...
void Check_300ms_srlr(void)
{
    ...
    {   
        ...
        if(cycleModeFlag_srlr == TRUE) { lin_FrDrCycleMode_TimerStop(); }
...
void Check_300ms_srud(void)
{
    ...
    {   
        ...
        if(cycleModeFlag_srud == TRUE) { lin_FrDrCycleMode_TimerStop(); }
...
void Check_300ms_5_cllr(void)
{
	...
	if(steplossCount_5_cllr >= 6)
	{
		goToTargetFlag_cllr = FALSE; 
		
		steplossCount_5_cllr = 0;
		
		if(gotoTargetPtCount_cllr < 5 && gotoZeroPtCount_cllr < 5)
		{	
//			recoveryFlags.FR_CLLR_Recov_Flag = TRUE;
...
void Check_300ms_5_clud(void)
{
	...
	if(steplossCount_5_clud >= 6)
	{
		goToTargetFlag_clud = FALSE; 
		
		steplossCount_5_clud = 0;
		
		if(gotoTargetPtCount_clud < 5 && gotoZeroPtCount_clud < 5)
		{	
			gotoZeroPtFlag_clud = TRUE;
...
void Check_300ms_5_sllr(void)
{
    ...
    if(steplossCount_5_sllr >= 6)
    {
        goToTargetFlag_sllr = FALSE;

        steplossCount_5_sllr = 0;

        if(gotoTargetPtCount_sllr < 5 && gotoZeroPtCount_sllr < 5)
        {   
            gotoZeroPtFlag_sllr = TRUE;
...
void Check_300ms_5_slud(void)
{
    ...
    if(steplossCount_5_slud >= 6)
    {
        goToTargetFlag_slud = FALSE;

        steplossCount_5_slud = 0;

        if(gotoTargetPtCount_slud < 5 && gotoZeroPtCount_slud < 5)
        {   
            gotoZeroPtFlag_slud = TRUE;
...
void Check_300ms_5_crlr(void)
{
    ...
    if(steplossCount_5_crlr >= 6)
    {
        goToTargetFlag_crlr = FALSE;

        steplossCount_5_crlr = 0;

        if(gotoTargetPtCount_crlr < 5 && gotoZeroPtCount_crlr < 5)
        {   
            gotoZeroPtFlag_crlr = TRUE;
...
void Check_300ms_5_crud(void)
{
    ...
    if(steplossCount_5_crud >= 6)
    {
        goToTargetFlag_crud = FALSE;

        steplossCount_5_crud = 0;

        if(gotoTargetPtCount_crud < 5 && gotoZeroPtCount_crud < 5)
        {   
            gotoZeroPtFlag_crud = TRUE;
...
void Check_300ms_5_srlr(void)
{
    ...
    if(steplossCount_5_srlr >= 6)
    {
        goToTargetFlag_srlr = FALSE;

        steplossCount_5_srlr = 0;

        if(gotoTargetPtCount_srlr < 5 && gotoZeroPtCount_srlr < 5)
        {   
            gotoZeroPtFlag_srlr = TRUE;
...
void Check_300ms_5_srud(void)
{
    ...
    if(steplossCount_5_srud >= 6)
    {
        goToTargetFlag_srud = FALSE;

        steplossCount_5_srud = 0;

        if(gotoTargetPtCount_srud < 5 && gotoZeroPtCount_srud < 5)
        {   
            gotoZeroPtFlag_srud = TRUE;
...
{
    if(fullcloseModeFlag_sllr == TRUE)
    {
        if(lin_Pt->FrDrPt.prevPt_FR_SLLR >= FullClose_UD_Rev && lin_Pt->FrDrPt.prevPt_FR_SLLR < 4096) { startPt_sllr = minusDegree; }
        else if(lin_Pt->FrDrPt.prevPt_FR_SLLR >= 0 && lin_Pt->FrDrPt.prevPt_FR_SLLR <= Min_UD) { startPt_sllr = plusDegree; }

        if(stopPt_sllr >= FullClose_UD_Rev && stopPt_sllr < 4096) { recoveryPt_sllr = minusDegree; }
        else if(stopPt_sllr >= 0 && stopPt_sllr <= Min_UD) { recoveryPt_sllr = plusDegree; }
    }
    else
    {
        if(lin_Pt->FrDrPt.prevPt_FR_SLLR >= Max_UD && lin_Pt->FrDrPt.prevPt_FR_SLLR < 4096) { startPt_sllr = minusDegree; }
        else if(lin_Pt->FrDrPt.prevPt_FR_SLLR >= 0 && lin_Pt->FrDrPt.prevPt_FR_SLLR <= Min_UD) { startPt_sllr = plusDegree; }

        if(stopPt_sllr >= Max_UD && stopPt_sllr < 4096) { recoveryPt_sllr = minusDegree; }
        else if(stopPt_sllr >= 0 && stopPt_sllr <= Min_UD) { recoveryPt_sllr = plusDegree; }
    }
...
void Handle_Recovery_StopPtCheck_slud(Lin_EVntPt_t *lin_Pt)
{
    ...
    if(startPt_slud == minusDegree)
    {
        ...
        {
            if(lin_Pt->FrDrPt.prevPt_FR_SLUD < stopPt_slud) { recoveryPattern_slud = Cant_go_to_zeroPt; }
...
{
    if(fullcloseModeFlag_crlr == TRUE)
    {
        if(lin_Pt->FrDrPt.prevPt_FR_CLLR >= FullClose_UD_Rev && lin_Pt->FrDrPt.prevPt_FR_CLLR < 4096) { startPt_crlr = minusDegree; }
        else if(lin_Pt->FrDrPt.prevPt_FR_CLLR >= 0 && lin_Pt->FrDrPt.prevPt_FR_CLLR <= Min_UD) { startPt_crlr = plusDegree; }

        if(stopPt_crlr >= FullClose_UD_Rev && stopPt_crlr < 4096) { recoveryPt_crlr = minusDegree; }
        else if(stopPt_crlr >= 0 && stopPt_crlr <= Min_UD) { recoveryPt_crlr = plusDegree; }
    }
    else
    {
        if(lin_Pt->FrDrPt.prevPt_FR_CLLR >= Max_UD && lin_Pt->FrDrPt.prevPt_FR_CLLR < 4096) { startPt_crlr = minusDegree; }
        else if(lin_Pt->FrDrPt.prevPt_FR_CLLR >= 0 && lin_Pt->FrDrPt.prevPt_FR_CLLR <= Min_UD) { startPt_crlr = plusDegree; }

        if(stopPt_crlr >= Max_UD && stopPt_crlr < 4096) { recoveryPt_crlr = minusDegree; }
        else if(stopPt_crlr >= 0 && stopPt_crlr <= Min_UD) { recoveryPt_crlr = plusDegree; }
    }
    ...
    if(startPt_crlr == minusDegree)
    {
        ...
        {
            if(lin_Pt->FrDrPt.prevPt_FR_CLLR < stopPt_crlr) { recoveryPattern_crlr = Cant_go_to_zeroPt; }
...
{
    if(fullcloseModeFlag_srlr == TRUE)
    {
        if(lin_Pt->FrPsPt.prevPt_FR_SRLR >= FullClose_UD_Rev && lin_Pt->FrPsPt.prevPt_FR_SRLR < 4096) { startPt_srlr = minusDegree; }
        else if(lin_Pt->FrPsPt.prevPt_FR_SRLR >= 0 && lin_Pt->FrPsPt.prevPt_FR_SRLR <= Min_UD) { startPt_srlr = plusDegree; }

        if(stopPt_srlr >= FullClose_UD_Rev && stopPt_srlr < 4096) { recoveryPt_srlr = minusDegree; }
        else if(stopPt_srlr >= 0 && stopPt_srlr <= Min_UD) { recoveryPt_srlr = plusDegree; }
    }
    else
    {
        if(lin_Pt->FrPsPt.prevPt_FR_SRLR >= Max_UD && lin_Pt->FrPsPt.prevPt_FR_SRLR < 4096) { startPt_srlr = minusDegree; }
        else if(lin_Pt->FrPsPt.prevPt_FR_SRLR >= 0 && lin_Pt->FrPsPt.prevPt_FR_SRLR <= Min_UD) { startPt_srlr = plusDegree; }

        if(stopPt_srlr >= Max_UD && stopPt_srlr < 4096) { recoveryPt_srlr = minusDegree; }
        else if(stopPt_srlr >= 0 && stopPt_srlr <= Min_UD) { recoveryPt_srlr = plusDegree; }
    }
...
void Recovery_Pattern_CantGoToZeroPt_cllr(t_lin_LH_FR_STATUS *lin_Status, Lin_EVntPt_t *lin_Pt)
{
	...
	//				zero_flag = 0;
			...
			{			
				...
				Amo_timer_Stop(timer_91);
				Amo_timer_Start(timer_91, 300, false, Check_300ms_1_cllr);
			}
		}
		else if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 0 && lin_Status->fr_cllr_status.LDATA.FR_CLLR_OpDone == 1) //recovery Clear
		{
			...
			else { Recovery_goToTargetPt_FR_CLLR_1(&LIN_LH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
		}
	}

	if(zero_flag_cllr == FALSE && eventCountTest_cllr == 2)
	{
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1 && (absDeltaPt_cllr>0 && absDeltaPt_cllr<=80))
		{
	//				zero_flag = 0;

			steplossCount_2_cllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_2_cllr == FALSE)
			{			
				Check300ms_flag_2_cllr = TRUE;
				
				Amo_timer_Stop(timer_91);
				Amo_timer_Start(timer_91, 300, false, Check_300ms_2_cllr);
			}
		}
		else if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 0 && lin_Status->fr_cllr_status.LDATA.FR_CLLR_OpDone == 1) //recovery Clear
		{
	...
	if(zero_flag_cllr == FALSE && eventCountTest_cllr == 3)
	{
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1 && (absDeltaPt_cllr>0 && absDeltaPt_cllr<=80))
		{
	//				zero_flag = 0;

			steplossCount_3_cllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_3_cllr == FALSE)
			{			
				Check300ms_flag_3_cllr = TRUE;
				
				Amo_timer_Stop(timer_91);
				Amo_timer_Start(timer_91, 300, false, Check_300ms_3_cllr);
			}
		}
		else if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 0 && lin_Status->fr_cllr_status.LDATA.FR_CLLR_OpDone == 1) //recovery Clear
		{
	...
	if(zero_flag_cllr == FALSE && eventCountTest_cllr == 4)
	{
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1 && (absDeltaPt_cllr>0 && absDeltaPt_cllr<=80))
		{
	//				zero_flag = 0;

			steplossCount_4_cllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_4_cllr == FALSE)
			{			
				Check300ms_flag_4_cllr = TRUE;
				
				Amo_timer_Stop(timer_91);
				Amo_timer_Start(timer_91, 300, false, Check_300ms_4_cllr);
			}
		}
		else if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 0 && lin_Status->fr_cllr_status.LDATA.FR_CLLR_OpDone == 1) //recovery Clear
		{
	...
	if(zero_flag_cllr == FALSE && eventCountTest_cllr == 5)
	{
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1 && (absDeltaPt_cllr>0 && absDeltaPt_cllr<=80))
		{
	//				zero_flag = 0;

			steplossCount_5_cllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_5_cllr == FALSE)
			{			
				Check300ms_flag_5_cllr = TRUE;
...
void Recovery_Pattern_CantGoToZeroPt_clud(t_lin_LH_FR_STATUS *lin_Status, Lin_EVntPt_t *lin_Pt)
{
	...
	if(zero_flag_clud == FALSE && eventCountTest_clud == 1)
	{
	...
	//				zero_flag = 0;
			...
			{			
				...
				Amo_timer_Stop(timer_96);
				Amo_timer_Start(timer_96, 300, false, Check_300ms_1_clud);
			}
		}
		else if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 0 && lin_Status->fr_clud_status.LDATA.FR_CLUD_OpDone == 1) //recovery Clear
		{
			...
			else { Recovery_goToTargetPt_FR_CLUD_1(&LIN_LH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
		}
	}

	if(zero_flag_clud == FALSE && eventCountTest_clud == 2)
	{
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1 && (absDeltaPt_clud>0 && absDeltaPt_clud<=80))
		{
	//				zero_flag = 0;

			steplossCount_2_clud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_2_clud == FALSE)
			{			
				Check300ms_flag_2_clud = TRUE;
				
				Amo_timer_Stop(timer_96);
				Amo_timer_Start(timer_96, 300, false, Check_300ms_2_clud);
			}
		}
		else if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 0 && lin_Status->fr_clud_status.LDATA.FR_CLUD_OpDone == 1) //recovery Clear
		{
	...
	if(zero_flag_clud == FALSE && eventCountTest_clud == 3)
	{
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1 && (absDeltaPt_clud>0 && absDeltaPt_clud<=80))
		{
	//				zero_flag = 0;

			steplossCount_3_clud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_3_clud == FALSE)
			{			
				Check300ms_flag_3_clud = TRUE;
				
				Amo_timer_Stop(timer_96);
				Amo_timer_Start(timer_96, 300, false, Check_300ms_3_clud);
			}
		}
		else if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 0 && lin_Status->fr_clud_status.LDATA.FR_CLUD_OpDone == 1) //recovery Clear
		{
	...
	if(zero_flag_clud == FALSE && eventCountTest_clud == 4)
	{
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1 && (absDeltaPt_clud>0 && absDeltaPt_clud<=80))
		{
	//				zero_flag = 0;

			steplossCount_4_clud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_4_clud == FALSE)
			{			
				Check300ms_flag_4_clud = TRUE;
				
				Amo_timer_Stop(timer_96);
				Amo_timer_Start(timer_96, 300, false, Check_300ms_4_clud);
			}
		}
		else if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 0 && lin_Status->fr_clud_status.LDATA.FR_CLUD_OpDone == 1) //recovery Clear
		{
	...
	if(zero_flag_clud == FALSE && eventCountTest_clud == 5)
	{
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1 && (absDeltaPt_clud>0 && absDeltaPt_clud<=80))
		{
	//				zero_flag = 0;

			steplossCount_5_clud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

			if(Check300ms_flag_5_clud == FALSE)
			{			
				Check300ms_flag_5_clud = TRUE;
...
{
    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 1)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Start(timer_106, 300, false, Check_300ms_1_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
            ...
            else { Recovery_goToTargetPt_FR_SLLR_1(&LIN_LH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
        }
    }

    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 2)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            steplossCount_2_sllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_2_sllr == FALSE)
            {            
                Check300ms_flag_2_sllr = TRUE;
                
                Amo_timer_Stop(timer_107);
                Amo_timer_Start(timer_107, 300, false, Check_300ms_2_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 3)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            steplossCount_3_sllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_3_sllr == FALSE)
            {            
                Check300ms_flag_3_sllr = TRUE;
                
                Amo_timer_Stop(timer_108);
                Amo_timer_Start(timer_108, 300, false, Check_300ms_3_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 4)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            steplossCount_4_sllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_4_sllr == FALSE)
            {            
                Check300ms_flag_4_sllr = TRUE;
                
                Amo_timer_Stop(timer_109);
                Amo_timer_Start(timer_109, 300, false, Check_300ms_4_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_sllr == FALSE && eventCountTest_sllr == 5)
    {
        if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1 && (absDeltaPt_sllr>0 && absDeltaPt_sllr<=80))
        {
            steplossCount_5_sllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_5_sllr == FALSE)
            {            
                Check300ms_flag_5_sllr = TRUE;
                
                Amo_timer_Stop(timer_110);
                Amo_timer_Start(timer_110, 300, false, Check_300ms_5_sllr);
            }
        }
        else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1) //recovery Clear
        {
...
{
    if(zero_flag_slud == FALSE && eventCountTest_slud == 1)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Start(timer_112, 300, false, Check_300ms_1_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
            ...
            else { Recovery_goToTargetPt_FR_SLUD_1(&LIN_LH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
        }
    }

    if(zero_flag_slud == FALSE && eventCountTest_slud == 2)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            steplossCount_2_slud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_2_slud == FALSE)
            {            
                Check300ms_flag_2_slud = TRUE;
                
                Amo_timer_Stop(timer_113);
                Amo_timer_Start(timer_113, 300, false, Check_300ms_2_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_slud == FALSE && eventCountTest_slud == 3)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            steplossCount_3_slud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_3_slud == FALSE)
            {            
                Check300ms_flag_3_slud = TRUE;
                
                Amo_timer_Stop(timer_114);
                Amo_timer_Start(timer_114, 300, false, Check_300ms_3_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_slud == FALSE && eventCountTest_slud == 4)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            steplossCount_4_slud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_4_slud == FALSE)
            {            
                Check300ms_flag_4_slud = TRUE;
                
                Amo_timer_Stop(timer_115);
                Amo_timer_Start(timer_115, 300, false, Check_300ms_4_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_slud == FALSE && eventCountTest_slud == 5)
    {
        if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1 && (absDeltaPt_slud>0 && absDeltaPt_slud<=80))
        {
            steplossCount_5_slud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_5_slud == FALSE)
            {            
                Check300ms_flag_5_slud = TRUE;
                
                Amo_timer_Stop(timer_116);
                Amo_timer_Start(timer_116, 300, false, Check_300ms_5_slud);
            }
        }
        else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1) //recovery Clear
        {
...
{
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 1)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Start(timer_118, 300, false, Check_300ms_1_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
            ...
            else { Recovery_goToTargetPt_FR_CRLR_1(&LIN_RH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
        }
    }

    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 2)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            steplossCount_2_crlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_2_crlr == FALSE)
            {            
                Check300ms_flag_2_crlr = TRUE;
                
                Amo_timer_Stop(timer_119);
                Amo_timer_Start(timer_119, 300, false, Check_300ms_2_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 3)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            steplossCount_3_crlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_3_crlr == FALSE)
            {            
                Check300ms_flag_3_crlr = TRUE;
                
                Amo_timer_Stop(timer_120);
                Amo_timer_Start(timer_120, 300, false, Check_300ms_3_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 4)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            steplossCount_4_crlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_4_crlr == FALSE)
            {            
                Check300ms_flag_4_crlr = TRUE;
                
                Amo_timer_Stop(timer_121);
                Amo_timer_Start(timer_121, 300, false, Check_300ms_4_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crlr == FALSE && eventCountTest_crlr == 5)
    {
        if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1 && (absDeltaPt_crlr>0 && absDeltaPt_crlr<=80))
        {
            steplossCount_5_crlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_5_crlr == FALSE)
            {            
                Check300ms_flag_5_crlr = TRUE;
                
                Amo_timer_Stop(timer_122);
                Amo_timer_Start(timer_122, 300, false, Check_300ms_5_crlr);
            }
        }
        else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1) //recovery Clear
        {
...
{
    if(zero_flag_crud == FALSE && eventCountTest_crud == 1)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Start(timer_124, 300, false, Check_300ms_1_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
            ...
            else { Recovery_goToTargetPt_FR_CRUD_1(&LIN_RH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
        }
    }

    if(zero_flag_crud == FALSE && eventCountTest_crud == 2)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            steplossCount_2_crud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_2_crud == FALSE)
            {            
                Check300ms_flag_2_crud = TRUE;
                
                Amo_timer_Stop(timer_125);
                Amo_timer_Start(timer_125, 300, false, Check_300ms_2_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crud == FALSE && eventCountTest_crud == 3)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            steplossCount_3_crud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_3_crud == FALSE)
            {            
                Check300ms_flag_3_crud = TRUE;
                
                Amo_timer_Stop(timer_126);
                Amo_timer_Start(timer_126, 300, false, Check_300ms_3_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crud == FALSE && eventCountTest_crud == 4)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            steplossCount_4_crud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_4_crud == FALSE)
            {            
                Check300ms_flag_4_crud = TRUE;
                
                Amo_timer_Stop(timer_127);
                Amo_timer_Start(timer_127, 300, false, Check_300ms_4_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_crud == FALSE && eventCountTest_crud == 5)
    {
        if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1 && (absDeltaPt_crud>0 && absDeltaPt_crud<=80))
        {
            steplossCount_5_crud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_5_crud == FALSE)
            {            
                Check300ms_flag_5_crud = TRUE;
                
                Amo_timer_Stop(timer_128);
                Amo_timer_Start(timer_128, 300, false, Check_300ms_5_crud);
            }
        }
        else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1) //recovery Clear
        {
...
{
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 1)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            ...
            {            
                ...
                Amo_timer_Start(timer_130, 300, false, Check_300ms_1_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
            ...
            else { Recovery_goToTargetPt_FR_SRLR_1(&LIN_RH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
        }
    }

    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 2)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            steplossCount_2_srlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_2_srlr == FALSE)
            {            
                Check300ms_flag_2_srlr = TRUE;
                
                Amo_timer_Stop(timer_131);
                Amo_timer_Start(timer_131, 300, false, Check_300ms_2_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 3)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            steplossCount_3_srlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_3_srlr == FALSE)
            {            
                Check300ms_flag_3_srlr = TRUE;
                
                Amo_timer_Stop(timer_132);
                Amo_timer_Start(timer_132, 300, false, Check_300ms_3_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 4)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            steplossCount_4_srlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_4_srlr == FALSE)
            {            
                Check300ms_flag_4_srlr = TRUE;
                
                Amo_timer_Stop(timer_133);
                Amo_timer_Start(timer_133, 300, false, Check_300ms_4_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srlr == FALSE && eventCountTest_srlr == 5)
    {
        if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1 && (absDeltaPt_srlr>0 && absDeltaPt_srlr<=80))
        {
            steplossCount_5_srlr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_5_srlr == FALSE)
            {            
                Check300ms_flag_5_srlr = TRUE;
                
                Amo_timer_Stop(timer_134);
                Amo_timer_Start(timer_134, 300, false, Check_300ms_5_srlr);
            }
        }
        else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1) //recovery Clear
        {
...
{
    if(zero_flag_srud == FALSE && eventCountTest_srud == 1)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            ...
            {            
                ...
                Amo_timer_Stop(timer_136);
                Amo_timer_Start(timer_136, 300, false, Check_300ms_1_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
            ...
            else { Recovery_goToTargetPt_FR_SRUD_1(&LIN_RH_EVNT_MASTER_CMD, &LIN_EVNT_PT); }
        }
    }

    if(zero_flag_srud == FALSE && eventCountTest_srud == 2)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            steplossCount_2_srud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_2_srud == FALSE)
            {            
                Check300ms_flag_2_srud = TRUE;
                
                Amo_timer_Stop(timer_137);
                Amo_timer_Start(timer_137, 300, false, Check_300ms_2_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srud == FALSE && eventCountTest_srud == 3)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            steplossCount_3_srud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_3_srud == FALSE)
            {            
                Check300ms_flag_3_srud = TRUE;
                
                Amo_timer_Stop(timer_138);
                Amo_timer_Start(timer_138, 300, false, Check_300ms_3_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srud == FALSE && eventCountTest_srud == 4)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            steplossCount_4_srud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_4_srud == FALSE)
            {            
                Check300ms_flag_4_srud = TRUE;
                
                Amo_timer_Stop(timer_139);
                Amo_timer_Start(timer_139, 300, false, Check_300ms_4_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
    ...
    if(zero_flag_srud == FALSE && eventCountTest_srud == 5)
    {
        if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1 && (absDeltaPt_srud>0 && absDeltaPt_srud<=80))
        {
            steplossCount_5_srud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6

            if(Check300ms_flag_5_srud == FALSE)
            {            
                Check300ms_flag_5_srud = TRUE;
                
                Amo_timer_Stop(timer_140);
                Amo_timer_Start(timer_140, 300, false, Check_300ms_5_srud);
            }
        }
        else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1) //recovery Clear
        {
...
void Recovery_Pattern_Repeat_zeroPt_cllr(t_lin_LH_FR_STATUS *lin_Status, Lin_EVntPt_t *lin_Pt)
{
	...
	if(zero_flag_cllr == TRUE && eventCountTest_cllr == 2)
	{
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
	...
	if(zero_flag_cllr == TRUE && eventCountTest_cllr == 3)
	{	
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
	...
	if(zero_flag_cllr == TRUE && eventCountTest_cllr == 4)
	{	
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
	...
	if(zero_flag_cllr == TRUE && eventCountTest_cllr == 5)
	{	
		if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
...
{
	if(zero_flag_clud == TRUE && eventCountTest_clud == 1)
	{	
	...
	if(zero_flag_clud == TRUE && eventCountTest_clud == 2)
	{
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
	...
	if(zero_flag_clud == TRUE && eventCountTest_clud == 3)
	{	
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
	...
	if(zero_flag_clud == TRUE && eventCountTest_clud == 4)
	{	
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
	...
	if(zero_flag_clud == TRUE && eventCountTest_clud == 5)
	{	
		if(lin_Status->fr_clud_status.LDATA.FR_CLUD_Steploss == 1)// && (absDeltaPt>0 && absDeltaPt<=80))
		{
	//				zero_flag = 0;
...
{
	if(zero_flag_sllr == TRUE && eventCountTest_sllr == 1)
	{	
		if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1)
		{
			steplossCount_1_sllr++;
		...
		else if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 0 && lin_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone == 1)
		{
	...
	if(zero_flag_sllr == TRUE && eventCountTest_sllr == 2)
	{
		if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1)
		{
			steplossCount_2_sllr++;
	...
	if(zero_flag_sllr == TRUE && eventCountTest_sllr == 3)
	{	
		if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1)
		{
			steplossCount_3_sllr++;
	...
	if(zero_flag_sllr == TRUE && eventCountTest_sllr == 4)
	{	
		if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1)
		{
			steplossCount_4_sllr++;
	...
	if(zero_flag_sllr == TRUE && eventCountTest_sllr == 5)
	{	
		if(lin_Status->fr_sllr_status.LDATA.FR_SLLR_Steploss == 1)
		{
			steplossCount_5_sllr++;
...
//		zeroPt = l_u16_rd_LI0_FR_CLLR_ActuatorState();
	...
	//				eventCountTest++;
			...
			Amo_timer_Start(timer_111, 300, false, GO_To_TargetPt_sllr); //50 //1000
...
{
	if(zero_flag_slud == TRUE && eventCountTest_slud == 1)
	{	
		if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1)
		{
		...
		else if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == 1)
		{
	...
	if(zero_flag_slud == TRUE && eventCountTest_slud == 2)
	{
		if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1)
		{
			steplossCount_2_slud++;
	...
	if(zero_flag_slud == TRUE && eventCountTest_slud == 3)
	{	
		if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1)
		{
			steplossCount_3_slud++;
	...
	if(zero_flag_slud == TRUE && eventCountTest_slud == 4)
	{	
		if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1)
		{
			steplossCount_4_slud++;
	...
	if(zero_flag_slud == TRUE && eventCountTest_slud == 5)
	{	
		if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 1)
		{
			steplossCount_5_slud++;
	...
	if(lin_Status->fr_slud_status.LDATA.FR_SLUD_Steploss == 0 && recoveryModeFlag_slud == TRUE)
	{
		...
		if((lin_Status->fr_slud_status.LDATA.FR_SLUD_OpDone == true)) //&& ((zeroPt >= 0 && zeroPt < 30) || (zeroPt > 2038 && zeroPt < 2048)))
		{
			...
			Amo_timer_Start(timer_117, 300, false, GO_To_TargetPt_slud); //50 //1000
...
{
	if(zero_flag_crlr == TRUE && eventCountTest_crlr == 1)
	{	
		if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1)
		{
			steplossCount_1_crlr++;
		...
		else if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == 1)
		{
	...
	if(zero_flag_crlr == TRUE && eventCountTest_crlr == 2)
	{
		if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1)
		{
			steplossCount_2_crlr++;
	...
	if(zero_flag_crlr == TRUE && eventCountTest_crlr == 3)
	{	
		if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1)
		{
			steplossCount_3_crlr++;
	...
	if(zero_flag_crlr == TRUE && eventCountTest_crlr == 4)
	{	
		if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1)
		{
			steplossCount_4_crlr++;
	...
	if(zero_flag_crlr == TRUE && eventCountTest_crlr == 5)
	{	
		if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 1)
		{
			steplossCount_5_crlr++;
	...
	if(lin_Status->fr_crlr_status.LDATA.FR_CRLR_Steploss == 0 && recoveryModeFlag_crlr == TRUE)
	{
		...
		if((lin_Status->fr_crlr_status.LDATA.FR_CRLR_OpDone == true)) //&& ((zeroPt >= 0 && zeroPt < 30) || (zeroPt > 2038 && zeroPt < 2048)))
		{
			...
			Amo_timer_Start(timer_123, 300, false, GO_To_TargetPt_crlr); //50 //1000
		
			//			Recovery_goToTargetPt_FR_CLLR_1(&LIN_RH_EVNT_MASTER_CMD, &LIN_EVNT_PT);
		}
	}
}
...
{
	if(zero_flag_crud == TRUE && eventCountTest_crud == 1)
	{	
		if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1)
		{
		...
		else if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == 1)
		{
	...
	if(zero_flag_crud == TRUE && eventCountTest_crud == 2)
	{
		if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1)
		{
			steplossCount_2_crud++;
	...
	if(zero_flag_crud == TRUE && eventCountTest_crud == 3)
	{	
		if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1)
		{
			steplossCount_3_crud++;
	...
	if(zero_flag_crud == TRUE && eventCountTest_crud == 4)
	{	
		if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1)
		{
			steplossCount_4_crud++;
	...
	if(zero_flag_crud == TRUE && eventCountTest_crud == 5)
	{	
		if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 1)
		{
			steplossCount_5_crud++;
	...
	if(lin_Status->fr_crud_status.LDATA.FR_CRUD_Steploss == 0 && recoveryModeFlag_crud == TRUE)
	{
		...
		if((lin_Status->fr_crud_status.LDATA.FR_CRUD_OpDone == true)) //&& ((zeroPt >= 0 && zeroPt < 30) || (zeroPt > 2038 && zeroPt < 2048)))
		{
			...
			Amo_timer_Start(timer_129, 300, false, GO_To_TargetPt_crud); //50 //1000
...
{
	if(zero_flag_srlr == TRUE && eventCountTest_srlr == 1)
	{	
		if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1)
		{
			steplossCount_1_srlr++;
		...
		else if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == 1)
		{
	...
	if(zero_flag_srlr == TRUE && eventCountTest_srlr == 2)
	{
		if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1)
		{
			steplossCount_2_srlr++;
	...
	if(zero_flag_srlr == TRUE && eventCountTest_srlr == 3)
	{	
		if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1)
		{
			steplossCount_3_srlr++;
	...
	if(zero_flag_srlr == TRUE && eventCountTest_srlr == 4)
	{	
		if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1)
		{
			steplossCount_4_srlr++;
	...
	if(zero_flag_srlr == TRUE && eventCountTest_srlr == 5)
	{	
		if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 1)
		{
			steplossCount_5_srlr++;
	...
	if(lin_Status->fr_srlr_status.LDATA.FR_SRLR_Steploss == 0 && recoveryModeFlag_srlr == TRUE)
	{
		...
		if((lin_Status->fr_srlr_status.LDATA.FR_SRLR_OpDone == true)) //&& ((zeroPt >= 0 && zeroPt < 30) || (zeroPt > 2038 && zeroPt < 2048)))
		{
			...
			Amo_timer_Stop(timer_135);
			Amo_timer_Start(timer_135, 300, false, GO_To_TargetPt_srlr); //50 //1000
...
{
	if(zero_flag_srud == TRUE && eventCountTest_srud == 1)
	{	
		...
		else if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == 1)
		{
	...
	if(zero_flag_srud == TRUE && eventCountTest_srud == 2)
	{
		if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1)
		{
			steplossCount_2_srud++;
	...
	if(zero_flag_srud == TRUE && eventCountTest_srud == 3)
	{	
		if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1)
		{
			steplossCount_3_srud++;
	...
	if(zero_flag_srud == TRUE && eventCountTest_srud == 4)
	{	
		if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1)
		{
			steplossCount_4_srud++;
	...
	if(zero_flag_srud == TRUE && eventCountTest_srud == 5)
	{	
		if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 1)
		{
			steplossCount_5_srud++;
	...
	if(lin_Status->fr_srud_status.LDATA.FR_SRUD_Steploss == 0 && recoveryModeFlag_srud == TRUE)
	{
		...
		if((lin_Status->fr_srud_status.LDATA.FR_SRUD_OpDone == true)) //&& ((zeroPt >= 0 && zeroPt < 30) || (zeroPt > 2038 && zeroPt < 2048)))
		{
			...
			Amo_timer_Stop(timer_141);
			Amo_timer_Start(timer_141, 300, false, GO_To_TargetPt_srud); //50 //1000
...
void Steploss_check_cllr(t_lin_LH_FR_STATUS *lin_Status, Lin_EVntPt_t *lin_Pt)
{
	...
	if(l_flg_tst_LI0_FR_CLLR_Steploss_flag())
	{
		...
		if(eventCountTest_cllr == 0 && recoveryFinishFlag_cllr == FALSE)
		{
			if(lin_Status->fr_cllr_status.LDATA.FR_CLLR_Steploss == 1)// && lin_Status->fr_cllr_status.LDATA.FR_CLLR_OpDone == 0)
			{	
				steplossCount_cllr++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6, 350ms=7, 400ms=8, 450ms=9, 500ms=10

				if(Check300ms_flag_cllr == FALSE)
				{	
//					PINS_DRV_SetPins(GPIO_PORTC, TEST_OUT1_MASK);
					
					stopPt_cllr = l_u16_rd_LI0_FR_CLLR_ActuatorState();
									
					Check300ms_flag_cllr = TRUE;

					Handle_Recovery_StopPtCheck_cllr(&LIN_EVNT_PT);
					
					Amo_timer_Stop(timer_91);
					Amo_timer_Start(timer_91, 300, false, Check_300ms_cllr);
				}
			}
		}
...
void Steploss_check_clud(t_lin_LH_FR_STATUS *lin_Status, Lin_EVntPt_t *lin_Pt)
{
	if(l_flg_tst_LI0_FR_CLUD_Steploss_flag())
	{
		...
		if(eventCountTest_clud == 0 && recoveryFinishFlag_clud == FALSE)
		{
			...
			{	
				steplossCount_clud++; //50ms=1 , 100ms=2, 150ms=3, 200ms=4, 250ms=5, 300ms=6, 350ms=7, 400ms=8, 450ms=9, 500ms=10

				if(Check300ms_flag_clud == FALSE)
				{	
//					PINS_DRV_SetPins(GPIO_PORTC, TEST_OUT1_MASK);
					
					stopPt_clud = l_u16_rd_LI0_FR_CLUD_ActuatorState();
									
					Check300ms_flag_clud = TRUE;

					Handle_Recovery_StopPtCheck_clud(&LIN_EVNT_PT);
					
					Amo_timer_Stop(timer_96);
					Amo_timer_Start(timer_96, 300, false, Check_300ms_clud);
				}
			}
		}
