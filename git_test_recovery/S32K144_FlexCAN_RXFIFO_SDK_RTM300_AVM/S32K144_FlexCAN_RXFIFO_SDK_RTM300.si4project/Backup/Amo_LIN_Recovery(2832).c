...
//			FR_PS_ExtFlt_SET();
			...
			if((Hu_Fr_Dr_Vent_Mode == SWING_MODE) && (FrDrPsCycleMode_Flag == TRUE) && (secureMainFlag == FALSE))
			{
...
//            FR_PS_ExtFlt_SET();
            ...
            recoveryFlags.FR_CRLR_Recov_Flag = FALSE;
						...
						if((Hu_Fr_Ps_Vent_Mode == SWING_MODE) && (FrDrPsCycleMode_Flag == TRUE) && (secureMainFlag == FALSE))
						{
							FrDrPsCycleMode_Flag = FALSE;
