...
void lin_Read_FR_LH_OpDone(t_lin_LH_FR_STATUS *lin_LH_Status)
{
	if(l_flg_tst_LI0_FR_SLLR_OpDone_flag())
	{
		...
		if(lin_LH_Status->fr_sllr_status.LDATA.FR_SLLR_OpDone != 1) { Evt_queue_add(DEVICE_ACTUATOR_RECOVERY_EVENT); }
	}
	...
	if(l_flg_tst_LI0_FR_SLUD_OpDone_flag())
	{
		...
		if(lin_LH_Status->fr_slud_status.LDATA.FR_SLUD_OpDone != 1) { Evt_queue_add(DEVICE_ACTUATOR_RECOVERY_EVENT); }
	}
	...
	if(l_flg_tst_LI0_FR_CLLR_OpDone_flag())
	{
		...
		if(lin_LH_Status->fr_cllr_status.LDATA.FR_CLLR_OpDone != 1) { Evt_queue_add(DEVICE_ACTUATOR_RECOVERY_EVENT); }
	}
	...
	if(l_flg_tst_LI0_FR_CLUD_OpDone_flag())
	{
		...
		if(lin_LH_Status->fr_clud_status.LDATA.FR_CLUD_OpDone != 1) { Evt_queue_add(DEVICE_ACTUATOR_RECOVERY_EVENT); }
	}
